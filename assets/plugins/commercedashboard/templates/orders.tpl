                ...
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td class="actions text-xs-right">
                            <a href="<?= $moduleUrl ?>&route=orders" title="<?= $lang['dashboard.view'] ?>"><i class="fa fa-eye fa-fw"></i></a>
                            <a href="<?= $moduleUrl ?>&route=orders" title="<?= $lang['dashboard.edit'] ?>"><i class="fa fa-edit fa-fw"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
